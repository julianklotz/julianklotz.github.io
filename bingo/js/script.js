...
$(document).ready(function() {
	...
	for (i=0; i<24; i++)	{
		...
		if (i==12) {
			...
			$('#board').append("<div data-value='0' class='square character-count-" + JSONBingo.squares[i].square.length + "' id='sq"+i+"'><div class='text'><br/>"+JSONBingo.squares[i].square+"</div></div>");
		}
  }
